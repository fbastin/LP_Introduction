...
On peut distinguer à nouveau deux cas.

\mbox{}

Le cas 1, correspondant à l'indépendance linéaire, se traite comme pour la question de réalisabilité.

\mbox{}

Le cas 2 procède également de manière similaire à la réalisabilité, à ceci près que nous devons montrer que pour n'importe quel $\epsilon$, la solution $x-\epsilon y$ est optimale.
...
\frac{4!}{2!2!} = 6
$$
Le nombre de base est toutefois strictement plus petit puisqu'il y a forcément des colonnes linéairement dépendantes.
